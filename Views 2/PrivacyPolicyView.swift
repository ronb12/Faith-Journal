            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    Group {
                        ...
                        SectionView(
                            title: "4. Data Storage and Firebase",
                            content: """
                            Your data is stored locally on your device and synced to Firebase when you sign in with Apple.
                            
                            By using Firebase sync:
                            - Your data is encrypted in transit and at rest
                            - Your data is stored securely on Firebase servers
                            - Your data is subject to Firebase's Terms of Service
                            - Each user's data is isolated and private to their account
                            - You can sign out at any time in the app settings
                            
                            Your data is only accessible to you when signed in with your Apple ID. Firebase handles all data storage and security.
                            """
                        )
                        ...
                        SectionView(
                            ...
                            - With Firebase (for data sync and storage services)
                            - With Apple (for Sign in with Apple authentication and CloudKit services for Live Sessions)

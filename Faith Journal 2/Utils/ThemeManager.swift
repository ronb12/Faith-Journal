...
class ThemeManager: ObservableObject {
    @AppStorage("selectedColorTheme") private var storedTheme: String = Theme.default.rawValue
    ...
    private init() {
        ...
        if let savedTheme = Theme(rawValue: UserDefaults.standard.string(forKey: "selectedColorTheme") ?? Theme.default.rawValue) {
    ...
    /// Get colors for a specific theme (used for preview in picker)
    ...
    var colors: ThemeColors {
        return colorsForTheme(currentTheme)
    }
}

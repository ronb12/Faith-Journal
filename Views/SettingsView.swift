        ...
        if #available(iOS 17.0, *) {
            NavigationStack {
                ZStack {
                    ...
                    Section(header: Text("Color Theme"), footer: Text("Personalize your app with different color themes. Each theme includes unique accent colors.")) {
                    ...
                    // Removed: API key alert and message

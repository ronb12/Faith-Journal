...
class BibleStudyService: ObservableObject {
    ...
    private static func createTopicLibrary() -> [BibleStudyTopic] {
        ...
        // Define topics per category to total exactly 365
        // Counts: 33+28+28+20+20+20+20+20+16+16+16+16+16+16+16+16+10+10+10+10+8 = 365
        ...
        // Ensure exactly 365 topics
        if topics.count != 365 {
            print("⚠️ Warning: Generated \(topics.count) topics, expected 365. Limiting to 365.")
        }

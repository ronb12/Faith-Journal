...
struct PencilKitCanvas: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> PKCanvasView {
        ...
        canvasView.drawingPolicy = .anyInput // Support Apple Pencil, alternative styluses, and finger input
        canvasView.tool = PKInkingTool(.pen, color: .black, width: 15)
        
        // Configure tool picker for Apple Pencil support (after view is added to window)
...
// Legacy DrawingCanvas - kept for compatibility but no longer used
// Replaced by PencilKit for proper Apple Pencil support

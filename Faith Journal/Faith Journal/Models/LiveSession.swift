...
final class LiveSession {
    ...
    var currentBroadcasters: Int = 0 // Number of active broadcasters (limited by Agora to 17 recommended)
    ...
    var parentSessionId: UUID? // For recurring sessions, link to parent template
    var calendarEventId: String? // Store calendar event identifier for integration
    // Waiting room fields
    ...
    init(title: String, description: String, hostId: String, category: String, maxParticipants: Int = 10, tags: [String] = []) {
        ...
        self.currentBroadcasters = 1 // Host is always a broadcaster
        self.viewerCount = 0
        ...
        self.streamMode = "conference" // Default to conference mode (all can participate)

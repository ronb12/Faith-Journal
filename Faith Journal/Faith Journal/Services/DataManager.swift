...
class DataManager: ObservableObject {
    ...
    func deleteJournalEntriesContaining(_ searchText: String, context: ModelContext) -> Int {
        ...
        for entry in allEntries {
            let titleContains = entry.title.lowercased().contains(searchTextLower)
            let contentContains = entry.content.lowercased().contains(searchTextLower)
